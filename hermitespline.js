var HermiteSpline = function(dCnavas)
{
...
HermiteSpline.prototype.setShowControlPolygon = function(bShow)
{
	this.showControlPolygon = bShow;
}

HermiteSpline.prototype.setShowTangents = function(bShow)
{
	this.showTangents = bShow;
}

HermiteSpline.prototype.setNumSegments = function(val)
{
	this.numSegments = val;
}

HermiteSpline.prototype.newCurve = function(val)
{
	if(!this.closed){
...
HermiteSpline.prototype.setActiveCurve = function(activeCurve){
...
HermiteSpline.prototype.deleteCurve = function(){
	this.nodes[this.activeCurve].length = 0;
	this.status[this.activeCurve] = -1;
	this.activeCurve = -1;
	this.activeNode = -1;
	this.closed = true;
}

HermiteSpline.prototype.mousePress = function(event)
{
	if (event.button == 0) {
...
HermiteSpline.prototype.mouseMove = function(event) {
...
HermiteSpline.prototype.mouseRelease = function(event)
{
